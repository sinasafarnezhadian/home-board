...
function is(e) {
  const t = tt;
  return tt = e, Gl = e && e.type.__scopeId || null, t;
}
function Yl(e, t = tt, n) {
  if (!t || e._n)
    return e;
  const s = (...o) => {
    s._d && us(-1);
...
function Ca(e, t) {
  ...
  const {
    ...
    if (p === g)
      return;
    p && !zt(p, g) && (E = st(p), Fe(p, M, I, !0), p = null), g.patchFlag === -2 && (F = !1, g.dynamicChildren = null);
...
const Ci = ({ key: e }) => e ?? null, ts = ({
  ...
  ref_key: t,
  ref_for: n
}) => (typeof e == "number" && (e = "" + e), e != null ? Ce(e) || /* @__PURE__ */ Ae(e) || oe(e) ? { i: tt, r: e, k: t, f: !!n } : e : null);
...
function ko(e, t) {
  ...
  if (t == null)
    ...
    if (s & 65) {
      ...
      n = 32;
      const o = t._;
      !o && !vi(t) ? t._ctx = tt : o === 3 && tt && (tt.slots._ === 1 ? t._ = 1 : (t._ = 2, e.patchFlag |= 1024));
    }
  else oe(t) ? (t = { default: t, _ctx: tt }, n = 32) : (t = String(t), s & 64 ? (n = 16, t = [pt(t)]) : n = 8);
...
function Di(e) {
  _e && (_e.readyState === WebSocket.OPEN || _e.readyState === WebSocket.CONNECTING) || (nt = !1, _e = new WebSocket(Bu()), _e.onmessage = (t) => {
    var s, o;
    ...
    nt = !1, un && clearTimeout(un), un = setTimeout(() => {
      _e = null, Di(e);
    }, 5e3);
  }, _e.onerror = () => {
    _e == null || _e.close();
...
function Vu() {
  un && (clearTimeout(un), un = null), _e && (_e.close(), _e = null), nt = !1, Dn.clear(), qt.clear(), cn.clear(), ds.value = !1, Kn.value = null;
}
async function wn(e) {
  var n;
  if (Kn.value = e, !_e || !nt) {
    console.warn("[HomeBoard] Cannot save to HA: WS not connected", { ws: !!_e, authenticated: nt });
    return;
  }
...
function Fi() {
  Xn && clearTimeout(Xn), Xn = setTimeout(() => {
    if (Xn = null, !_e || !nt) {
      console.warn("[HomeBoard] scheduleSettingsSync skipped: WS not ready", { ws: !!_e, authenticated: nt });
      return;
    }
    const e = lo();
...
async function Wu(e, t, n, s) {
  if (!_e || !nt) throw new Error("WebSocket not connected");
  const o = Xt++;
...
function Uu(e) {
  ...
  function r(c, u) {
    a(), u && (t = u), o.value = !0, s.value = null, Di(c), l = i, ju(t, l), nt || fetch(Ts(`/api/states/${t}`), {
...
const zu = { class: "weather-layout" }, Ju = { class: "weather-left" }, Gu = { class: "weather-temp" }, Yu = { class: "weather-condition" }, Xu = {
  ...
  setup(e, { emit: t }) {
    ...
    function he(z) {
      ...
      function st() {
        document.body.style.userSelect = "", document.removeEventListener("mousemove", Qe), document.removeEventListener("mouseup", st), document.removeEventListener("touchmove", Qe), document.removeEventListener("touchend", st);
      ...
      document.addEventListener("mousemove", Qe), document.addEventListener("mouseup", st), document.addEventListener("touchmove", Qe), document.addEventListener("touchend", st);
    }
    return (z, Y) => (k(), A("div", {
...
{{ states('sensor.wohnzimmer_soll_temperatur') }} °C`;
    ...
    function q(b, _) {
      ...
      let xe = !1;
      const Ze = O.value.find((Nt) => Nt.id === _);
      if (!Ze) return;
      const gn = Ze;
      function Vn(Nt) {
...
}), ah = /* @__PURE__ */ qe(rh, [["__scopeId", "data-v-d568b131"]]);
